...
public class ProductionCalcTest extends WebDriverTest{
    ...
    public void addition4(){
        ...
        mainPage.seven.click();
        mainPage.equals.click();
        assertEquals(mainPage.answerBox.getText(), "25");
    }
    ...
    public void decimalAdd() {
        ...
        mainPage.four.click();
        mainPage.equals.click();
        assertEquals(3.15354, Double.parseDouble(mainPage.answerBox.getText()));
    }
